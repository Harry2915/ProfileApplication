...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewlgn=findViewById(R.id.tvlgn);
        textViewlgn.setOnClickListener(this);
    ...
    private void show_Message(String title, String input) {
        ...
        builder.setIcon(R.mipmap.my_icon1_round);
    ...
    private void show_Message_Confirmation(String success, String o) {
        ...
        builder_1.setIcon(R.mipmap.my_icon1_round);
        flag=0;
        builder_1.setPositiveButton("LOGIN", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {

                Intent intent_my = new Intent(MainActivity.this,ProfileActivity.class);
    ...
    public void onClick(View v) {
        Intent intent_lgn = new Intent(MainActivity.this,Login.class);
